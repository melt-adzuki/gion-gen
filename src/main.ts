...
tweet.addEventListener("click", () => window.open(`https://twitter.com/intent/tweet?hashtags=擬音ジェネレーター&url=https://hijiki02.github.io/GION/&text=${content.innerHTML}`))
github.addEventListener("click", () => window.open("https://github.com/hijiki02/GION"))
